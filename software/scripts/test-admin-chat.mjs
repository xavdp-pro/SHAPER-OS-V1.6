...
async function run() {
  ...
  await page.goto('https://ia.szde.fr/console/opencode/zaza/Administrateur', { waitUntil: 'domcontentloaded', timeout: 30000 });
  ...
  const artifactPath = '/home/zaza/.gemini/antigravity/brain/8dfc7b6b-357d-451b-9c4e-cadeed245854/chat_admin_tested.png';
  await page.screenshot({ path: artifactPath, fullPage: false });
  console.log('✓ Capture session Administrateur enregistrée dans :', artifactPath);
